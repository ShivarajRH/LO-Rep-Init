...
<body>
	<div class="header">
			<div class="logo">
				<a href="">
					<img class="fl_le" src="lyfeon.png" style="padding-left:1%;width:30px;margin-top:-0.3%;height:24px;"></img>
			...
			<div class="fl_ri menu_drop">
				<ul>
					...
					<li class="menu_drop_list last fl_ri"><a href=""><span class="">Profile</span></a>
						<ul>
							...
							<ul>
								<li>
									<p>
										...
										<a href="https://plus.google.com/102551492162357281309/posts" target="_blank">Taraka Anil Sabbineni</a>
									</p>
								</li>
								<li>
									<h3>LyfeOn Profile</h3>
								</li>
